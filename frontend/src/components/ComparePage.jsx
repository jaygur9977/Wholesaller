  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="bg-white rounded-xl shadow-lg p-12 text-center">
        <RocketLaunchIcon className="w-24 h-24 text-indigo-500 mx-auto mb-6 animate-bounce" />
        ...
        <p className="text-lg text-gray-600 mb-8">
          ...
          Our developers are putting the finishing touches on it!
        </p>
        ...
        {/* <Link href="/">
          <p className="mt-4 text-indigo-500 hover:underline cursor-pointer">Go back to Homepage</p>
        </Link> */}
      </div>
    </div>
  );
