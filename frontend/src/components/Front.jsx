...
import { MagnifyingGlassIcon, MapPinIcon, ChartBarIcon, ScaleIcon, ArrowPathIcon, ShoppingCartIcon, BuildingStorefrontIcon, UsersIcon, TruckIcon } from '@heroicons/react/24/outline'
import { useState } from 'react';
      ...
      <div className="relative bg-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
          <div className="lg:w-1/2">
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              <span className="block">Connecting Local Vendors</span>
              <span className="block text-indigo-400">with Trusted Wholesalers</span>
            </h1>
            <p className="mt-6 text-xl text-gray-300">
              Streamline your supply chain with our platform that bridges the gap between vendors and wholesalers. Find the best deals or expand your customer base effortlessly.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <button className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-700 bg-white hover:bg-gray-100 transition-colors duration-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides tools for both vendors and wholesalers to optimize their operations.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: "Find wholesalers in your area to reduce shipping costs and delivery times.",
                ...
                },
                {
                  ...
                  description: "Side-by-side comparison of prices, ratings, and delivery options.",
                  bgColor: "bg-blue-100",
                ...
                },
                {
                  ...
                  description: "Get multiple quotations instantly to negotiate the best deals.",
                ...
                },
                {
                  ...
                  description: "Track your purchases, savings, and supplier performance over time.",
                ...
                },
                {
                  ...
                  description: "Wholesalers can showcase their inventory with real-time updates.",
                ...
                },
                {
                  ...
                  description: "Expand your customer base by connecting with local vendors.",
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <div className="mt-10 lg:mt-0 lg:col-span-7">
              <div className="space-y-10">
                {[
                  {
                    quote: "This platform has transformed how we source products. We've reduced our supply costs by 15% while improving quality.",
                    author: "Sarah Johnson",
                    role: "Owner, FreshMart Groceries"
                  },
                  {
                    quote: "As a wholesaler, we've doubled our customer base in just 6 months by being visible to local vendors who need our products.",
                    author: "Michael Chen",
                    role: "Director, Premium Foods Wholesale"
                  },
                  {
                    quote: "The comparison tools saved us hours of research and helped us find reliable suppliers in our area quickly.",
                    author: "David Rodriguez",
                    role: "Procurement Manager, Urban Eats"
                  }
